...
<div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="/build/career" class="nav-link active">
  ...
  <button class="btn btn-outline-danger" style="float: right;" onclick="window.open('https://cw.or.kr/cid/job/jobOpeningsInfo.do')">더 많은 채용정보 보러가기</button>
  <div class="pt-5">
  <table class="table">
...
<c:forEach var="data" items="${api}">  
  <tbody class="table table-striped">
    <tr>
		...
		<td><button onclick="location='https://cw.or.kr/cid/job/jobOpeningsInfoView.do?cmpnyJoSeq=${data.num}'">이동하기</button></td>
	</tr>  
  </tbody>
</c:forEach>  
</table>
