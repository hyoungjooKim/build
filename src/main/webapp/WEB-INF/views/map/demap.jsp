...
<div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <hr>
      <li>
        <a href="/build/conmap" class="nav-link link-dark">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#worker"/></svg>
          시공
        </a>
      </li>
      <li>
        <a href="/build/demap" class="nav-link active">
  ...
  <!-- 작업 공간 -->
  <div>
  <h1 class="pt-5" style="color: #102D40;font-size: 40px;FONT-WEIGHT: 1000;">설계하실 위치를 선택해주세요.
  </h1>
